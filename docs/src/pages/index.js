...
`}
              ...
              <p>
                We will start by creating a <b>models</b> folder, in which we will create four subfolders,
                one for each model, and an index.js file for exporting them as an array of models.
              </p>
...
`
              ...
              <p>
                Create the same file for each models, simply changing the name property accordingly.
              </p>
              <p>
                ...
                in chat sessions, and a color that will be used of their speech bubbles. The username should be unique.
              </p>
              <p>
...
`}
              ...
              <p>
                The field file should export a function, which in turn must return an object containing
  ...
  queries: {
    ...
              ...
              <p>
                ...
                functions then returns the display name, and if it does not exist, it returns the username.
              </p>
