...
Configuration of the way the persistence instance logs its actions. Refer to the [Log util documentation](/api/utils#loggerconfig)
...
type AliasedResolverEnum = ResolverEnum|'get'|'list'|'edit'
```
