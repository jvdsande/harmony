...
import {
  FastifyInstance, FastifyReply, FastifyRequest, RouteOptions,
} from 'fastify'
...
export interface ServerRegistration {
  ...
  routeOptions?: Omit<RouteOptions, 'url'|'method'|'handler'>
}
    ...
    return async (
      ...
      app.register(
        async (instance) => {
          ...
          if (routeOptions && routeOptions.preHandler) {
            if (Array.isArray(routeOptions.preHandler)) {
              beforeHandlers.push(...routeOptions.preHandler)
            } else {
              beforeHandlers.push(routeOptions.preHandler)
            }
          }
